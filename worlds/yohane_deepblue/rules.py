...
def set_chest_rules(world: World) -> None:
    ...
    world.set_rule(world.get_location(LocationNames.katys_mask_room_chest), chika_rule & (you_rule | (soarshoes_rule & (chika_rule | upgraded_ruby_rule))))
    ...
    # Shipwreck
    world.set_rule(world.get_location(LocationNames.really_sealed_off_chest_room_chest), you_rule | (kanan_rule & riko_rule & CanReachRegion(LocationNames.grotto_region)))
    world.set_rule(
    ...
    world.set_rule(
        ...
        (CanReachRegion(LocationNames.coral_hill_region) | ((kanan_rule | you_rule | riko_rule) & (chika_rule | soarshoes_rule | gloves_rule))) & you_rule)
    world.set_rule(
    ...
    world.set_rule(
        ...
        you_rule & (CanReachRegion(LocationNames.coral_hill_region) | (kanan_rule | (you_rule & riko_rule))) & ((chika_rule & upgraded_mari_rule) | (kanan_rule & you_rule & gloves_rule))
    )
